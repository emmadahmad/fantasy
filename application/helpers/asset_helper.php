...
{
	return css($asset, 'frontend', $attributes);
}

function css_url($asset_name, $module_name = "frontend")
{
...
{
	return image($asset, 'frontend', $attributes);
}

function image_url($asset_name, $module_name = 'frontend')
{
	return get_asset_instance()->image_url($asset_name, $module_name);
}

function image_path($asset_name, $module_name = 'frontend')
{
...
{
	return js($asset, 'frontend', $attributes);
}

function js_url($asset_name, $module_name = "frontend")
{
