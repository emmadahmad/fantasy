...
class Asset {
  ...
  private function _other_asset_location($asset_name, $module_name = 'frontend', $asset_type = NULL, $location_type = 'url') {
    // Given a full URL
    ...
    if (strpos($asset_name, 'assets/') !== FALSE) {
      $asset_location = $base_location .$this->theme. $asset_name;
    }
    ...
    // Normal file (that might be in a module)
      ...
      if ($module_name != 'admin' && $module_name != 'frontend' && $module_name != NULL) {
        ...
        $asset_location .= $this->theme . '/'.( $asset_type == '' ? '' : $asset_type . '/') . $asset_name;
      }else{
        $asset_location .= $this->theme . '/' .$module_name. '/'.( $asset_type == '' ? '' : $asset_type . '/') . $asset_name;
      }
